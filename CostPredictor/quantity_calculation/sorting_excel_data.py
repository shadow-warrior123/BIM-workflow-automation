...
def merge_and_format_excel_files(material_takeoff_path, other_data_extraction_path, output_folder, root):
    try:
        ...
        root.quit()  # Close the window after processing

    except Exception as e:
        print(f"An error occurred: {e}")

def select_files_and_merge(root):
    ...
    merge_and_format_excel_files(material_takeoff_path, other_data_extraction_path, output_folder, root)

if __name__ == "__main__":
    root = tk.Tk()
    root.withdraw()  # Hide the root window
    select_files_and_merge(root)
    root.mainloop()
